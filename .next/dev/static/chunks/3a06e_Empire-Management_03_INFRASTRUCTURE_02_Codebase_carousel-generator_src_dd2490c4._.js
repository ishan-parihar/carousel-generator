...
function useTouchDrag(element, onDragStart, onDragEnd, config) {
    _s();
    const { updateElement } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$src$2f$store$2f$canvas$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCanvasStore"])();
...
_s(useTouchDrag, "PVpxInpYvjziRr+hS0jESsDt81E=", false, function() {
    return [
...
;
;
const TextElement = ({ element, isSelected, onSelect, onTransform, enableResize = true, enableRotate = true, keepAspectRatio = false })=>{
    _s();
    const { updateElement } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$src$2f$store$2f$canvas$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCanvasStore"])();
...
_s(TextElement, "cGW1H4cSWL1xYfKPt2u8E3ci688=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$src$2f$store$2f$canvas$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCanvasStore"]
    ];
});
...
;
/**
 * Convert canvas element position to slide position (percentage)
 *
 * @param x - Canvas element x position (pixels)
 * @param y - Canvas element y position (pixels)
 * @param width - Canvas element width (pixels)
 * @param height - Canvas element height (pixels)
 * @param rotation - Canvas element rotation (degrees)
 * @returns Element position in percentage format
 */ function canvasPositionToSlidePosition(x, y, width, height, rotation) {
    return {
        mode: 'absolute',
        x: x / __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLIDE_WIDTH"] * 100,
        y: y / __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLIDE_HEIGHT"] * 100,
        width: width / __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLIDE_WIDTH"] * 100,
        height: height / __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$src$2f$config$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SLIDE_HEIGHT"] * 100,
        rotation
    };
}
/**
 * Sync canvas elements back to slide data
 *
 * Converts canvas element changes to slide updates and writes them to the carousel store.
 * This ensures that canvas edits are persisted and reflected in DOM mode.
 *
 * @param elements - Canvas elements to sync
 * @param slideId - Slide ID to update
 * @param updateSlide - Function to update slide in carousel store
 */ function syncCanvasToDom(elements, slideId, updateSlide) {
    const slideContent = {};
        ...
        if (element.type === 'text') {
            ...
            if (element.name === 'Headline') {
                slideContent.headline = {
                    ...
                    position: canvasPositionToSlidePosition(element.x, element.y, element.width, element.height, element.rotation)
                };
    ...
    // Update slide in carousel store
    if (Object.keys(slideContent).length > 0) {
        console.log('[CanvasSlide] Syncing canvas changes to slide:', slideId, slideContent);
        updateSlide(slideId, slideContent);
    }
}
const CanvasSlide = ({ slide, pillar, carouselTotalSlides, carouselBackgroundPack, carouselDecoratorConfig, isPreview = false, scale = 1 })=>{
    _s();
    const { elements, addElement, updateElement, selectElement, selectedIds, clearElements } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$src$2f$store$2f$canvas$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCanvasStore"])();
    ...
    // Track initialization to prevent re-clearing elements
    const isInitializedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    // Track last slide content to detect actual changes
    const lastSlideRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(JSON.stringify(slide));
    // Track initialization per slide ID (persists across mode switches)
    const initializedSlidesRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Set());
    ...
    // Migrate slide to canvas elements
    const canvasElements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CanvasSlide.useMemo[canvasElements]": ()=>{
            return migrateSlideToCanvas(slide, theme, styleTemplate, subTypeConfig, decoratorConfig);
        }
    }["CanvasSlide.useMemo[canvasElements]"], [
        slide,
        theme,
    ...
    const debouncedSyncRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    useEffect({
        "CanvasSlide.useEffect": ()=>{
            const debouncedSync = debounce({
                "CanvasSlide.useEffect.debouncedSync": (elements)=>{
                    syncCanvasToDom(elements, slide.id, updateSlideRef.current);
                }
            }["CanvasSlide.useEffect.debouncedSync"], 500);
            debouncedSyncRef.current = debouncedSync;
            return ({
                "CanvasSlide.useEffect": ()=>{
                    // Cancel any pending sync on unmount by calling with empty map
                    if (debouncedSyncRef.current) {
                        debouncedSyncRef.current(new Map());
                    }
                }
            })["CanvasSlide.useEffect"];
        }
    ...
    // Sync canvas elements with store - ONLY on initial load or when slide actually changes
    useEffect({
        "CanvasSlide.useEffect": ()=>{
            const currentSlideString = JSON.stringify(slide);
            const slideAlreadyInitialized = initializedSlidesRef.current.has(slide.id);
            // Only re-migrate if slide content has actually changed
            if (slideAlreadyInitialized && currentSlideString === lastSlideRef.current) {
                console.log('[CanvasSlide] Slide content unchanged, skipping migration to preserve canvas edits');
                return; // Skip - slide hasn't changed, preserve user edits
            }
            console.log('[CanvasSlide] Migrating elements for slide:', slide.id);
            // Clear and re-migrate only when slide changes
            clearElements();
            // Add migrated elements - use current values from closure
            canvasElements.forEach({
                "CanvasSlide.useEffect": (element)=>{
                    addElement(element);
                }
            }["CanvasSlide.useEffect"]);
            // Update tracking refs
            isInitializedRef.current = true;
            initializedSlidesRef.current.add(slide.id);
            lastSlideRef.current = currentSlideString;
        }
    }["CanvasSlide.useEffect"], [
        slide.id
    ]); // Only depend on slide.id to prevent infinite loops
    // Sync canvas changes back to slide data (debounced)
    useEffect({
        "CanvasSlide.useEffect": ()=>{
            // Skip sync in preview mode or before initialization
            if (isPreview || !isInitializedRef.current) {
                return;
            }
            // Skip sync if debounced function is not ready
            if (!debouncedSyncRef.current) {
                return;
            }
            // Sync canvas changes to DOM (debounced, 500ms)
            debouncedSyncRef.current(elements);
            // Cleanup: cancel debounced sync on unmount
            return ({
                "CanvasSlide.useEffect": ()=>{
                // Debounced function will be cancelled by the cleanup in the effect above
                }
            })["CanvasSlide.useEffect"];
        }
    }["CanvasSlide.useEffect"], [
    ...
    const handleElementTransform = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CanvasSlide.useCallback[handleElementTransform]": (elementId)=>({
                "CanvasSlide.useCallback[handleElementTransform]": (transform)=>{
                    ...
                    updateElement(elementId, transform);
                }
...
_s(CanvasSlide, "XwMRcTMTwuYjmg15GdrAkLqTzCc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$src$2f$store$2f$canvas$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCanvasStore"],
...
//# sourceMappingURL=3a06e_Empire-Management_03_INFRASTRUCTURE_02_Codebase_carousel-generator_src_dd2490c4._.js.map