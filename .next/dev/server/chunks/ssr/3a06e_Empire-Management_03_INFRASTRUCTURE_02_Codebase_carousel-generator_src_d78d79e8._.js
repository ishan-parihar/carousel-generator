...
function migrateBullets(slide, theme) {
    ...
    // Get style configuration (Phase 1)
    const styleConfig = typeof bulletsContent === 'object' && bulletsContent.style ? bulletsContent.style : undefined;
    // Calculate element position and size
...
function createContentFromDOMCarousel(carousel) {
    const slides = carousel.slides.map((slide, index)=>({
            slideNumber: index + 1,
            contentFields: createContentFieldsFromSlide(slide)
        }));
    return {
        slides
    };
 ...
 */ function createElementsFromSlide(slide, theme, pillar) {
    ...
    elements.push({
        ...
        opacity: 1,
        data: {
            color: theme.backgroundColor || '#0a0a0a',
            backgroundType: 'solid',
    ...
    if (content.imageConfig) {
        const imageUrl = content.imageConfig.url || content.imageConfig.imageUrl;
        if (imageUrl) {
            elements.push({
                id: 'image',
                type: 'image',
                x: 540,
                y: 500,
                width: content.imageConfig.width || 900,
                height: content.imageConfig.height || 600,
                rotation: 0,
                zIndex: 5,
                locked: false,
                visible: true,
                ...
                data: {
                    imageUrl,
                    caption: content.imageConfig.caption || content.imageConfig.alt || '',
                    objectFit: content.imageConfig.objectFit || 'cover',
                    opacity: 1
                }
            });
        }
 ...
 */ function createContentFieldsFromSlide(slide) {
    ...
    if (content.headline) {
        const headlineValue = typeof content.headline === 'string' ? content.headline : content.headline.value;
        if (headlineValue) {
            fields['headline'] = headlineValue;
        }
    }
    if (content.subtext) {
        const subtextValue = typeof content.subtext === 'string' ? content.subtext : content.subtext.value;
        if (subtextValue) {
            fields['subtext'] = subtextValue;
        }
    }
    if (content.bullets) {
        const bulletsValue = Array.isArray(content.bullets) ? content.bullets : typeof content.bullets === 'string' ? content.bullets : content.bullets.value;
        if (Array.isArray(bulletsValue)) {
            fields['bullets'] = bulletsValue;
        }
    }
    if (content.quote) {
        const quoteValue = typeof content.quote === 'string' ? content.quote : content.quote.value;
    ...
    if (content.attribution) {
        const attributionValue = typeof content.attribution === 'string' ? content.attribution : content.attribution.value;
        if (attributionValue) {
            fields['attribution'] = attributionValue;
        }
    }
    if (content.imageConfig) {
        const imageUrl = content.imageConfig.url || content.imageConfig.imageUrl;
    ...
    if (slide.cta) {
        fields['cta'] = slide.cta.text || 'Learn More';
    }
    return fields;
}
}),
"[project]/Documents/Obsidian-Vault/Ishan-Parihar/00_Empire-Management/03_INFRASTRUCTURE/02_Codebase/carousel-generator/src/lib/export/png-exporter.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Documents/Obsidian-Vault/Ishan-Parihar/00_Empire-Management/03_INFRASTRUCTURE/02_Codebase/carousel-generator/src/lib/export/batch-exporter.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$node_modules$2f$jszip$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/Obsidian-Vault/Ishan-Parihar/00_Empire-Management/03_INFRASTRUCTURE/02_Codebase/carousel-generator/node_modules/jszip/lib/index.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$node_modules$2f$file$2d$saver$2f$dist$2f$FileSaver$2e$min$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/Obsidian-Vault/Ishan-Parihar/00_Empire-Management/03_INFRASTRUCTURE/02_Codebase/carousel-generator/node_modules/file-saver/dist/FileSaver.min.js [app-ssr] (ecmascript)");
;
;
async function createZipFromExports(exports, zipName) {
    const zip = new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Obsidian$2d$Vault$2f$Ishan$2d$Parihar$2f$00_Empire$2d$Management$2f$03_INFRASTRUCTURE$2f$02_Codebase$2f$carousel$2d$generator$2f$node_modules$2f$jszip$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]();
...
//# sourceMappingURL=3a06e_Empire-Management_03_INFRASTRUCTURE_02_Codebase_carousel-generator_src_d78d79e8._.js.map